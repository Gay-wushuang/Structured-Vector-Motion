...
| INV-REF-001 | specified | JSON Schema requires a SHA-256 reference hash; artifact import is pending. |
| INV-REF-002 | specified | Document Format defines URI as locator only. |
